...
const Service2 = () => {
    return (
      <>
        <section className="block md:flex bg-teal-100 w-screen h-max">
          <div className="block md:w-1/2 md:border-2 md:border-black md:my-auto h-auto p-10 mb-10 md:mb-auto relative">
            <div
              id="back1"
              className="absolute top-16 right-12 w-28 h-28 rounded-tr-[45%] rounded-tl-[75%] rounded-br-[45%] bg-teal-300"
            ></div>
            <div
              id="back2"
              className="absolute bottom-1  left-6 w-28 h-28 rounded-tl-[45%] rounded-bl-[75%] rounded-br-[45%] bg-teal-500"
            ></div>
            <div id="back3" className=""></div>
            <div className="">
              <div className="absolute bottom-10 left-16 bg-teal-400 border-r-8 border-teal-300 rounded-tl-[75%] rounded-tr-[70%] w-64 h-52"></div>
